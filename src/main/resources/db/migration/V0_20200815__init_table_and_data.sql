...
(
    ...
    subscribe_count      int(11)      NOT NULL COMMENT '订阅数',
...
(
    ...
    price         int(11)       NOT NULL COMMENT '订阅价格',
    word_count    int(11)       NOT NULL COMMENT '字数',
...
insert into user(id, username, nickname, avatar, mobile, password, introduction, coin, role, qq_account, email,
                 auth_name, id_card, user_sign_status, sex, address, age, level_id, signature, recommend_ticket,
                 wall_ticket, type_id, birthday, secrecy_config, chat_status)
values (1, 'admin', '', '', '', '', '', 0, 4, '', '', '', '', 0, 1, '', 100, 1, '', 0, 0, 0, '2020-08-15 00:00:00', '{}', 0);
insert into type(id, name, belong, parent_id)VALUES (1, '男频', 2, 0);
insert into type(id, name, belong, parent_id)VALUES (2, '女频', 2, 0);
INSERT INTO goods (id, type, resource, coin) VALUES (1, 1, '{"fateBoardGoods": {"name": "普通1", "upAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/%E6%9C%A8%E7%89%8C1-_%E6%8C%82%E8%B5%B72.png", "downAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/img_yq_male.png"}}', 0);
INSERT INTO goods (id, type, resource, coin) VALUES (2, 1, '{"fateBoardGoods": {"name": "普通2", "upAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/%E6%9C%A8%E7%89%8C3-_%E6%8C%82%E8%B5%B72.png", "downAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/img_yq_female.png"}}', 0);
INSERT INTO goods (id, type, resource, coin) VALUES (3, 1, '{"fateBoardGoods": {"name": "红梅", "upAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/fateBoard4-1.jpg", "downAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/fateBoard4-2.jpg"}}', 60);
INSERT INTO goods (id, type, resource, coin) VALUES (4, 1, '{"fateBoardGoods": {"name": "清竹", "upAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/fateBoard5-2.jpg", "downAppearance": "https://goods-1301318552.cos.ap-nanjing.myqcloud.com/fateBoard/fateBoard5-1.jpg"}}', 60);
INSERT INTO user_level (id, level, level_name) VALUES (1, 1, 'LV1');
INSERT INTO user_level (id, level, level_name) VALUES (2, 2, 'LV2');
INSERT INTO user_level (id, level, level_name) VALUES (3, 3, 'LV3');
INSERT INTO user_level (id, level, level_name) VALUES (4, 4, '白银');
INSERT INTO user_level (id, level, level_name) VALUES (5, 5, '黄金');
INSERT INTO user_level (id, level, level_name) VALUES (6, 6, '大神');
